...
- 29215df: An `environments:` block and `--env <name>`, the first half of ROADMAP.md milestone 0.9.
...
- 6a93e31: `gtm.environments`, the second half of ROADMAP.md milestone 0.9.
...
- 08dda6b: Fixes the first `apply` in a fresh project failing with `ENOENT` on `.analytics/state.json.lock`.
